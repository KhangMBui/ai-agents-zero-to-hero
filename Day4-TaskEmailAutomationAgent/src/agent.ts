...
import { readPdfSummary } from "./tools/read_pdf";
import { scheduleEvent } from "./tools/schedule_event";
import { logTask } from "./tools/memory";
...
export const TaskAgent = new Agent({
  ...
  `,
  model: "gpt-4.1",
  tools: [sendEmail, scheduleEvent, readPdfSummary, logTask],
});
